            ...
            <div className=" w-full">
                ...
                <div className="">
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <button
                            className="group relative w-full flex justify-center py-2 px-6 border border-transparent text-xl font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mt-10"
                            onClick={() => {
                                setNamaProgramState("")
                                setPengarahProgramState("")
                                setKlusterProgramState("")
